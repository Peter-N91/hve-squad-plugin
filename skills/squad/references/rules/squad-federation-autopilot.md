...
* **Single-squad autopilot** (`skills/squad/references/rules/squad-autopilot.md`) runs the research → plan → council → implement → review → final-outcome pipeline for one squad. It is unchanged by these conventions.
